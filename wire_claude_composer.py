...
def wire_composer():
    ...
    print(f"Targeting: {components_dir}")
    print("Wiring Unified Claude-Style Composer Component...")

    composer_code = """import React, { useState, useRef, useEffect } from 'react';
...
"""
    composer_path = os.path.join(components_dir, "ClaudeComposer.tsx")
    with open(composer_path, "w", encoding="utf-8") as f:
        f.write(composer_code)

    print(f"✓ Unified Claude Composer generated: {composer_path}")
    print("✓ Visual continuity established between landing and authenticated views.")
