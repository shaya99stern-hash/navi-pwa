    ...
    <main className="grid min-h-dvh place-items-center bg-[#191614] px-4 py-8 text-[#f7f0e8]">
      <section className="w-full max-w-[430px]">
        <header className="mb-8 text-center">
          <NaviMark className="mx-auto mb-5 h-12 w-12 text-[#d67249]" label="NaviOS" />
          <p className="mb-2 text-[0.6875rem] font-semibold uppercase tracking-[0.16em] text-[#d67249]">NaviOS</p>
        ...
        <p className="mt-5 text-center text-xs leading-5 text-[#938a81]">NaviOS is a private, local-first workspace.</p>
      </section>
    </main>
  );
}
