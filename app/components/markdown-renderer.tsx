      ...
      components={{
        ...
        code: ({ className, children }) => {
          ...
          if (language === "navi-capability") {
            ...
            if ("error" in parsed) {
              return <div className="my-3 rounded-2xl border border-[var(--border-subtle)] bg-elev-2 p-3 text-[0.8125rem]/[1.125rem] text-tertiary">NaviSol drafted a capability that could not be read: {parsed.error}</div>;
            }
            return (
              <CapabilityCard
