      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between gap-3 px-4 pb-3 pt-1">
          <div>
            ...
            <div className="text-[0.75rem]/4 font-medium text-tertiary">What Navi Soul can reach outside this app</div>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 pb-2">
          <div className="overflow-hidden rounded-card border border-[var(--border-subtle)] bg-elev-2">
            <Row
              ...
              detail={
                !known ? "Checking…"
                  : status.github
                    ? "Navi Soul can read your repositories, files, pull requests, and CI runs. Read-only — it cannot push or merge."
            ...
            <Row
              ...
              detail={
                connectorCount
                  ...
                  : "Connect a remote MCP server over HTTPS to give Navi Soul access to your own tools and data."
              }
              action="Manage"
          ...
          <p className="px-2 pt-3 text-[0.75rem]/[1.125rem] text-tertiary">
            ...
            or wrongly-scoped token cannot pass as working. Access is read-only by construction — Navi Soul
