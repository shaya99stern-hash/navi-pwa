...
const discovered = { provider: "openrouter" as const, model: "vendor/fresh-coder:free", label: "NaviSol", capability: "coding" as const };
...
check("a discovered route is labelled with the product", discovered.label, "NaviSol");
