...
const onlyGemini: ProviderAvailability = { gemini: true, groq: false, huggingface: false, cerebras: false, openrouter: false, mistral: false, deepseek: false, together: false, nvidia: false, sambanova: false };
